...
namespace TasahelExpress.Migrations
{
    ...
    [Migration("20260701123549_AddWarehousePendingToOrder")]
    partial class AddWarehousePendingToOrder
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PostexS.Models.Domain.CourierOrderSheet", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("CourierOrderSheets");
                });

            modelBuilder.Entity("PostexS.Models.Domain.CourierOrderSheetItem", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("CourierOrderSheetItems");
                });
            ...
            modelBuilder.Entity("PostexS.Models.Domain.EmployeeMoneyTransferRequest", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<long?>("AdminWalletEntryId")
                        .HasColumnType("bigint");
                    ...
                    b.Property<long?>("EmployeeWalletEntryId")
                        .HasColumnType("bigint");
                    ...
                    b.ToTable("EmployeeMoneyTransferRequests");
                });

            modelBuilder.Entity("PostexS.Models.Domain.LandingPageContent", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PostexS.Models.Domain.LandingPartner", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("LandingPartners");
                });

            modelBuilder.Entity("PostexS.Models.Domain.LandingStatistic", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PostexS.Models.Domain.LandingTestimonial", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("PostexS.Models.Domain.Order", b =>
                {
                    ...
                    b.Property<string>("ClientSecondaryPhone")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("PostexS.Models.Domain.WapilotSettings", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.Property<int>("MessageIntervalSeconds")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PostexS.Models.Domain.WhatsAppBotCloudSettings", b =>
                {
                    ...
                    b.ToTable("WhatsAppBotCloudSettings");
                });
            ...
            modelBuilder.Entity("PostexS.Models.Domain.WhatsAppProviderSettings", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
                    ...
                    b.ToTable("WhatsAppProviderSettings");
                });
            ...
            modelBuilder.Entity("PostexS.Models.Domain.ApplicationUser", b =>
                {
                    ...
                    b.Property<bool>("HideSenderCode")
                        .HasColumnType("bit");

                    b.Property<bool>("HideSenderName")
                        .HasColumnType("bit");

                    b.Property<bool>("HideSenderPhone")
                        .HasColumnType("bit");
                    ...
                    b.Property<bool>("OrdersGoToWarehousePending")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("PostexS.Models.Domain.CourierOrderSheet", b =>
                {
                    b.HasOne("PostexS.Models.Domain.ApplicationUser", "Courier")
                        .WithMany()
                        .HasForeignKey("CourierId");

                    b.HasOne("PostexS.Models.Domain.ApplicationUser", "CreatedBy")
                        .WithMany()
            ...
            modelBuilder.Entity("PostexS.Models.Domain.CourierOrderSheetItem", b =>
                {
                    ...
                    b.HasOne("PostexS.Models.Domain.CourierOrderSheet", "Sheet")
                        .WithMany("Items")
            ...
            modelBuilder.Entity("PostexS.Models.Domain.EmployeeMoneyTransferRequest", b =>
                {
                    b.HasOne("PostexS.Models.Domain.ApplicationUser", "Admin")
                        .WithMany()
                        .HasForeignKey("AdminUserId");

                    b.HasOne("PostexS.Models.Domain.ApplicationUser", "Employee")
                        .WithMany()
            ...
            modelBuilder.Entity("PostexS.Models.Domain.WhatsAppMessageQueue", b =>
                {
                    b.HasOne("PostexS.Models.Domain.ApplicationUser", "CreatedByUser")
                        .WithMany()
                    ...
                    b.HasOne("PostexS.Models.Domain.ApplicationUser", "Sender")
                        .WithMany()
